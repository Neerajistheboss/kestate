    ...
    <div className="container mx-auto min-h-[800px] mb-14">
      <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between">
        ...
        <div className="mb-4 lg:mb-0 flex gap-x-2 text-sm">
          <div className="bg-cyan-500 rounded-full text-white px-3 inline-block">
            {property.type}
          </div>
          <div className="bg-teal-500 rounded-full text-white px-3 inline-block">
            {property.country}
          </div>
        </div>
      ...
      <div className="flex flex-col items-start gap-8 lg:flex-row">
        <div className="max-w-[768px]">
          ...
          <div className="flex gap-x-6 text-teal-700 mb-6">
        ...
        <div className="flex-1 w-full mb-8 bg-white border border-gray-300 rounded-lg px-6 py-8">
          <div className="flex items-center gap-x-4 mb-8">
            ...
            <div>
              ...
              <Link to="" className="text-teal-700 text-sm">
                View listings
              </Link>
            </div>
          </div>
          <form className="flex flex-col gap-y-4">
            <input
              className="border border-gray-300 focus:border-teal-700 rounded w-full px-4 h-14 text-sm outline-none"
              type="text"
              placeholder="Name*"
            />
            <input
            ...
            />
            <textarea
              className="border border-gray-300 focus:border-teal-700 rounded w-full p-4 h-36 text-sm text-gray-400 outline-none resize-none"
              type="text"
              placeholder="Message*"
            ...
            <div className="flex gap-x-2">
              <button
                className="bg-teal-700 hover:bg-teal-800 text-white rounded p-4 text-sm w-full transition"
                type="submit"
              >
                Send message
              </button>
